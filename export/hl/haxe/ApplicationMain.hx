...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Playground", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Playground", null, 640, 360);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Playground";
		app.meta["name"] = "Playground";
